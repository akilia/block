...
function blocks_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_blocks'] = array(
		...
		'field'=> array(
			...
			'bouton_titre'       => 'text NOT NULL DEFAULT ""',
			'bouton_lien'        => 'text NOT NULL DEFAULT ""',
			'bouton_class'       => 'varchar(255) NOT NULL DEFAULT ""',
		...
		'titre' => 'titre AS titre, lang AS lang',
		 #'date' => '',
		'champs_editables'  => array('block_element', 'block_id', 'block_class', 'container_class', 'enfants', 'titre', 'masquer_titre', 'soustitre', 'texte', 'bouton_titre', 'bouton_lien', 'bouton_class'),
		'champs_versionnes' => array('titre', 'soustitre', 'texte', 'bouton_titre'),
